...
cc.Class({
    ...
    createRankItem (index, imgURL, name, score, openid) {
        ...
        cell.init(index + 1, imgURL, name,  score, openid);
    ...
    UpdateRankList () {
        ...
        for (let index = 0; index < GameData.instance.friendData.length; index++) {
            ...
            self.createRankItem(index, data.avatarUrl, data.nickname, data.KVDataList[0].value, data.openid);
        }
    },
